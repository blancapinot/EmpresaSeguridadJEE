...
public class Cliente extends Usuario {
    ...
    public Cliente(String nombre, String apellido, Integer rut, String fechaNacimiento, String telefono, String afp, String sistemaDeSalud, String comuna, int edad, String direccion) {
